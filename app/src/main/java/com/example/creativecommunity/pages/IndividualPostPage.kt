        ...
        try {
            ...
            val postResult = withContext(Dispatchers.IO) {
                 SupabaseClient.client.postgrest.from("posts")
                    .select(Columns.raw("id, image_url, caption, content, users!inner(id, username, email, profile_image, bio, auth_id)")) { // Fetch user info including auth_id
                 ...
                 LazyColumn(modifier = Modifier.fillMaxSize()) {
                    ...
                    item {
                        Post(
                            ...
                            caption = postDetails!!.caption ?: postDetails!!.content ?: "",
